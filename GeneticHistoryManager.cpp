...
GeneticHistory::GeneticHistory(string file) {
    ...
    vector<string> build_order_list = {
	   ...
	   "drone drone drone overlord drone drone drone drone hatch pool drone extract drone drone drone drone ling ling hydra_den drone lair queens_nest queen queen"
	};
...
//Genetic Algorithm below
    ...
    if constexpr (TEST_MODE) {
		...
		build_order_ = "drone drone drone drone overlord drone drone drone drone hatch pool extract drone drone drone ling ling lair hatch overlord drone ling ling ling drone drone drone overlord hydra_den queens_nest hydra hydra hydra hydra hydra gamete_meiosis queen";
		//build_order_ = "drone drone drone drone overlord drone drone drone drone hatch pool extract drone drone evo drone drone ling ling speed hatch hydra_den carapace overlord drone grooved_spines ling ling ling drone drone drone drone overlord muscular_augments hydra hydra hydra hydra hydra";
